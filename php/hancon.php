...
if(empty($_GET['thisposition'])){
	...
	if($to==md5('login')){
		if($_POST['v']=='guru'){
			$ru->loginguru($con,$_POST['username'],$_POST['password'],$_POST['tp']);
		}
		elseif($_POST['v']=='admin'){
			$ru->loginadmin($con,$_POST['username'],$_POST['password'],$_POST['tp']);
		}
		elseif($_POST['v']=='wamur'){
			$ru->loginwali($con,$_POST['username'],$_POST['password'],$_POST['tp']);
		}
