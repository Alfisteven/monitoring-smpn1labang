      ...
      <ul class="sidebar-menu">
        ...
        <li <?php echo $bak; ?>>
          <a href="<?php echo $basegu; ?>inputpelanggaran">
            <i class="glyphicon glyphicon-remove"></i> <span>Input Pelanggaran</span>
          </a>
        </li><li <?php echo $bak; ?>>
          <a href="<?php echo $basegu; ?>inputkehadiran">
            <i class="glyphicon glyphicon-check"></i> <span>Input Ketidakhadiran</span>
          </a>
        </li>
        <li <?php echo $cak; ?>>
...
?>
  ...
  <footer class="main-footer">
    ...
    <strong><a href="#">by Muhammad Alfis Sholikhin</a></strong> 
  </footer>
  <!-- Control Sidebar -->
