  ...
  <div class="col-xs-12 col-md-12 col-lg-12">
    <div class="box box-info">
      ...
      <div class="box-body">
          ...
          <tbody>
<?php $smk=mysqli_query($con,"SELECT * FROM siswa where c_kelas='$k' and (nisn like '%$s%' or nama like '%$s%') and siswa.status='Aktif' order by nama asc ");$vr=1;$jumakh=mysqli_num_rows($smk);
      if($jumakh>NULL){
