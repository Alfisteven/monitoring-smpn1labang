        ...
        <?php $_SESSION['pesan'] = '';?>
          <div class="box box-info">
            <div class="box-header  with-border">
              <h3 class="box-title">&nbsp;History Input Pelanggaran Siswa</h3><span class="pull-right"><a href="<?php echo $basegu; ?>inputpelanggaran" class="btn bg-navy btn-sm"><i class="glyphicon glyphicon-plus"></i> Input Pelanggaran</a> <a target="_blank" class="btn bg-blue btn-sm" href="<?php echo $basegu.'print/printpelguru?guru='.$_SESSION['c_guru'].'&tp=';?><?php echo "$tp";?>"><i class="glyphicon glyphicon-print"></i> Print</a></span>
            </div>
            <!-- /.box-header -->
            <div class="box-body table-responsive">
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tbody>
<?php $smk=mysqli_query($con,"SELECT * FROM pelanggaran where c_guru='$_SESSION[c_guru]' and tp='$tp' order by at desc ");$vr=1;while($akh=mysqli_fetch_array($smk)){
