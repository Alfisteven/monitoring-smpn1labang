...
<?php $smk=mysqli_query($con,"SELECT * FROM guru order by nama asc ");$vr=1;while($akh=mysqli_fetch_array($smk)){?>                
                <tr>
                  ...
                  <a target="_blank" class="btn bg-blue btn-sm" href="<?php echo $basead.'print/printpelguru?guru='.$akh['c_guru'].'&tp='; ?><?php echo "$tp";?>"><i class="glyphicon glyphicon-print"></i> Print</a></td>
                </tr>
