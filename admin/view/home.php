...
$jwa=mysqli_query($con,"SELECT * FROM kelas ");$hwa=mysqli_num_rows($jwa);
$jpe=mysqli_query($con,"SELECT * FROM pelanggaran where tp='$tp'");$hpe=mysqli_num_rows($jpe);
?>
...
$(function () {
    ...
    $(document).ready(function() {
        chart = new Highcharts.Chart({
            ...
            series: [
            <?php $kel=mysqli_query($con,"SELECT * FROM kelas order by kelas asc "); while($dkel=mysqli_fetch_array($kel)){ $jum=mysqli_query($con,"SELECT * FROM pelanggaran where c_kelas='$dkel[c_kelas]' and tp='$tp'"); $jumpel=mysqli_num_rows($jum); ?>
            {  
      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box" style="border-bottom: 3px solid #f0ad4e;">
            <a href="<?php echo $basead; ?>kelas"><span class="info-box-icon bg-yellow"><i class="glyphicon glyphicon-home"></i></span></a>
  ...
  <div class="col-md-4">
    <div class="box">
      ...
      <table class="table table-hover">
        <thead></thead>
        <tbody>
    <?php $vr=1; $pyd=mysqli_query($con,"SELECT c_benpel, count(c_benpel) as bp from pelanggaran where tp='$tp' group by c_benpel order by bp desc limit 5 ");while($hpyd=mysqli_fetch_array($pyd)){
