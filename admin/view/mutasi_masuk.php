      ...
      <div class="row">
        ...
        <?php $_SESSION['pesan'] = '';?>
          <div class="box box-info">
            ...
            <?php }else{?>
              <h3 class="box-title"></span>&nbsp;Data Mutasi Masuk</h3>
            <?php } ?>
             <span style="float:right;"><a href="<?php echo $basead; ?>input_mutasimasuk" class="btn btn-circle btn-primary btn-sm"><i class="glyphicon glyphicon-plus"></i> Tambah Mutasi</a></span>
            </div>
            <!-- /.box-header -->
...
<?php
$vr=1;
$smk=mysqli_query($con,"select * from mutasi,siswa where siswa.c_siswa=mutasi.c_siswa and mutasi.jenis='1'");
...
<div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">Konfirmasi Hapus Mutasi Siswa</h4>
        </div>
        <div class="modal-body">
          <p>Jika Anda Menghapus Data Ini, Akan Berpengaruh Pada</p>
          <b>1. Data Siswa (<?php echo $akh['nama']; ?>) Juga Terhapus<br>2. Data Pelanggaran Siswa (<?php echo $akh['nama']; ?>) Secara Keseluruhan Juga Terhapus</b>
        </div>
        <div class="modal-footer">
        
          <a href="<?php echo $basead; ?>a-control/<?php echo md5('hapusmutasimasuk').'/'.$akh['c_siswa']; ?>" class="btn btn-primary btn-circle"><i class="glyphicon glyphicon-ok"></i> Lanjutkan</a> 
