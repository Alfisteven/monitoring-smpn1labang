          ...
          <div class="box box-info">
            ...
            <div class="box-body table-responsive">
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tbody>
<?php $smk=mysqli_query($con,"SELECT * FROM kelas order by kelas asc ");$vr=1;while($akh=mysqli_fetch_array($smk)){ $jsis=mysqli_num_rows(mysqli_query($con,"SELECT * from siswa where c_kelas='$akh[c_kelas]' ")); $jpe=mysqli_num_rows(mysqli_query($con,"SELECT * from pelanggaran where c_kelas='$akh[c_kelas]' and tp='$tp'")); $ppe=mysqli_fetch_array(mysqli_query($con,"SELECT sum(bobot) as poin from pelanggaran where c_kelas='$akh[c_kelas]' and tp='$tp' "));  ?>
                <tr>
                  <td><?php echo $vr; ?></td>
                  ...
                  <a target="_blank" class="btn bg-blue btn-sm" href="<?php echo $basead.'print/printpelkelas?kelas='.$akh['c_kelas'].'&tp='; ?><?php echo "$tp";?>"><i class="glyphicon glyphicon-print"></i> Print</a></td>
                </tr>
