<form action="<?php echo $basead; ?>a-control/<?php echo md5('inputpel'); ?>/accesss" method="post" enctype="multipart/form-data">
...
if(empty($_POST['pilih'])){ ?>
  <a href="<?php echo $basead; ?>inputpelanggaran" class="btn btn-danger"><i class="glyphicon glyphicon-menu-left"></i> Anda Harus Memilih Siswa</a>
<?php } else { ?>
...
<?php } ?>
        ...
        <p>Pastikan Anda Telah Memilih Pelanggaran Yang Siswa Lalukan dan sertakan bukti pelanggaran (jika ada)</p><br />
        <?php $tang=date('Y-m-d');?>
        <input type="date" name="tgl" class="form-control" value="<?php echo "$tang";?>">
        <input type="file" name="fupload" id="fileField" class="form-control"/><br />
