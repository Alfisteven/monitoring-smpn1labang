            ...
            <input type="hidden" name="c_siswa" value="<?php echo $_GET['q']; ?>">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" required="" name="ortu" class="form-control" value="<?php echo $hasis['ortu']; ?>"> 
                </div>
                <div class="form-group">
                  <label>NO. HP</label>
                  <input type="text" required="" name="hp" class="form-control" value="<?php echo $hasis['hp']; ?>">
                </div>
                <div class="form-group">
                  <label>ALAMAT TINGGAL</label>
                  <input type="text" required="" name="tinggal" class="form-control" value="<?php echo $hasis['tinggal']; ?>">
                </div>
                <div class="form-group">
                  <label>STATUS</label>
                  <select name="status" class="form-control">
                    <option disabled="disabled">-- Pilih Status --</option>
                    <option value="Aktif" <?php if($hasis['status']=='Aktif'){echo "Selected";}else{echo "";}?>>Aktif</option>
                    <option value="Keluar" <?php if($hasis['status']=='Keluar'){echo "Selected";}else{echo "";}?>>Keluar</option>
                    <option value="Mutasi" <?php if($hasis['status']=='Mutasi'){echo "Selected";}else{echo "";}?>>Mutasi</option>
                    <option value="Lulus" <?php if($hasis['status']=='Lulus'){echo "Selected";}else{echo "";}?>>Lulus</option>
                  </select>
                </div>
              </div>
              <!-- /.box-body -->
