...
<h3 class="text-center">Laporan Pelanggaran Kelas ('.$kel['kelas'].')<br />
Tahun Pelajaran '.$tp.'
</h3>
...
$smk=mysqli_query($con,"SELECT * FROM pelanggaran where c_kelas='$_GET[kelas]' and tp='$tp' order by at desc ");$vr=1;while($akh=mysqli_fetch_array($smk)){
