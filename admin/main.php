...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-lg"><b>TP. <?php echo "$tp";?></b></span>
    </a>
...
?>
      ...
      <ul class="sidebar-menu">
        ...
        <li <?php echo $cak; ?>>
          ...
          <ul class="treeview-menu">
            <li <?php echo $drop1; ?>><a href="<?php echo $basead; ?>inputpelanggaran"><i class="glyphicon glyphicon-ok"></i> <span>Input Pelanggaran</span></a></li>
            <li <?php echo $drop3; ?>><a href="<?php echo $basead; ?>pelanggaransiswa"><i class="glyphicon glyphicon-remove-circle"></i> <span>Pelanggaran Siswa</span></a></li>
          </ul>
        </li>
         <li <?php echo $dak; ?>>
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li <?php echo $drop1; ?>><a href="<?php echo $basead; ?>kelas"><i class="glyphicon glyphicon-tags"></i> <span>Kelas</span></a></li>
        ...
        <li <?php echo $eak; ?>>
          ...
          <ul class="treeview-menu">
            <li <?php echo $drop1; ?>><a href="<?php echo $basead; ?>siswa"><i class="glyphicon glyphicon-education"></i> <span>Siswa Aktif</span></a></li>
            <li <?php echo $drop2; ?>><a href="<?php echo $basead; ?>non"><i class="glyphicon glyphicon-remove"></i> <span>Siswa Nonaktif</span></a></li>
          </ul>
        </li>
        <li <?php echo $fak; ?>>
       ...
       <li <?php echo $gak; ?>>
          ...
          <ul class="treeview-menu">
            <li <?php echo $drop1; ?>><a href="<?php echo $basead; ?>harian"><i class="glyphicon glyphicon-file"></i> <span>Lap. Harian</span></a></li>
            <li <?php echo $drop2; ?>><a href="<?php echo $basead; ?>bulanan"><i class="glyphicon glyphicon-file"></i> <span>Lap. Bulanan</span></a></li>
            <li <?php echo $drop2; ?>><a href="<?php echo $basead; ?>kehadiran"><i class="glyphicon glyphicon-file"></i> <span>Lap. Ketidakhadiran Siswa</span></a></li>
          </ul>
        </li>
      </ul>
    </section>
...
<?php
  if(empty($_GET['smkakh'])){require 'view/home.php';}
    ...
    if($act=='kategoripelanggaran'){
      ...
      require 'view/bukti.php';
    }
    else if($act=='siswa'){
      require 'view/a-siswa.php';
    }
	 else if($act=='non'){
      require 'view/non.php';
    }
	...
	else if($act=='peringatan'){
      require 'view/peringatan.php';
    }
	else if($act=='harian'){
      require 'view/harian.php';
    }
	else if($act=='bulanan'){
      require 'view/bulanan.php';
    }
	else if($act=='tangan-1'){
      require 'view/tangan-1.php';
    }
    else if($act=='delpena'){
      require 'view/delete_penanganan.php';
    }
    else if($act=='penanganan'){
      require 'view/penanganan.php';
    }
    else if($act=='impsiswa'){
      require 'view/import.php';
    }
	else if($act=='naik'){
      require 'view/naik.php';
    }
	else if($act=='mmasuk'){
      require 'view/mutasi_masuk.php';
    }
    else if($act=='input_mutasimasuk'){
      require 'view/input_mutasimasuk.php';
    }
	else if($act=='mkeluar'){
      require 'view/mutasi_keluar.php';
    }
    else if($act=='input_mutasikeluar'){
      require 'view/input_mutasikeluar.php';
    }
	else if($act=='kehadiran'){
      require 'view/kehadiran.php';
    }
	else if($act=='kehadiran_siswa'){
      require 'view/kehadiran_siswa.php';
    }
	else{
...
?>
  ...
  <footer class="main-footer">
    ...
    <strong>by<a href="#"> Muhammad Alfis Sholikhin</a></strong> 
  </footer>
  <!-- Control Sidebar -->
