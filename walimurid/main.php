...
//$or=mysqli_fetch_array(mysqli_query($con,"SELECT * FROM orangtua where c_orangtua='$_SESSION[c_orangtua]' ")); 
$siswa=mysqli_fetch_array(mysqli_query($con,"SELECT * FROM siswa where nisn='$_SESSION[c_orangtua]' ")); 
$kelas=mysqli_fetch_array(mysqli_query($con,"SELECT * FROM kelas where c_kelas='$siswa[c_kelas]' ")); 
$pel=mysqli_num_rows(mysqli_query($con,"SELECT * FROM pelanggaran where c_siswa='$or[c_siswa]' ")); 
$totalpel=mysqli_fetch_array(mysqli_query($con,"SELECT sum(bobot) as total FROM pelanggaran where c_siswa='$siswa[c_siswa]' ")); 
?>
      ...
      <div class="container">
        ...
        <div class="navbar-custom-menu navbar">
          <ul class="nav navbar-nav navbar-left">
            ...
            <li class="user user-menu"><a href="<?php echo $base.'php/'.md5('logout'); ?>"><img src="<?php echo $base; ?>php/img/ortu.png" class="user-image" alt="User Image"><span>&nbsp;<?php echo $siswa['ortu']; ?> <i class="glyphicon glyphicon-log-out"></i></span></a></li>
          </ul>
        </div>
        <!-- /.navbar-custom-menu -->
      </div>
...
?>
  ...
  <footer class="main-footer">
    <div class="container">
      ...
      <strong>Copyright &copy; 2021 <a href="#">SMKN 1 Tambakboyo</a></strong> by M. Imam Sholikin, S.Kom
    </div>
    <!-- /.container -->
  </footer>
</div>
